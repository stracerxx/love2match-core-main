...
for (let i = 0; i < users.length; i++) {
  ...
  try {
    ...
    if (user.bio && user.bio.trim()) transformedUser.bio = user.bio;
    if (user.home_city && user.home_city.trim()) transformedUser.home_city = user.home_city;
    if (user.occupation && user.occupation.trim()) transformedUser.occupation = user.occupation;
    if (user.solana_wallet_address && user.solana_wallet_address.trim()) transformedUser.solana_wallet_address = user.solana_wallet_address;
